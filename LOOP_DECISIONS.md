...
> **执行顺序**：✅EVT 尾部风险 → ✅DSR 因子-AUC deflation(#10a) → ✅E 保形预测(诚实区间) → ✅F 周期(谱+红噪声,小波延期,commit 29bca3b) → ⏳**FDR 跨检验族(#7,下一项)** → C RDD(#先核 Russell 数据,不行就老实跳过) → CoinGecko 挪服务端(#6) → 周末新闻刷新(#5) → 页面归类(#15,可逆,你随时调布局)。
>
