...
╔══════════════════════════════════════════════════════════════════════╗
║  ⚠ 沙箱说明：作者(子代理)无法跑代码/WebFetch SEC 被 403(UA 限制)。      ║
║  下列端点/字段路径来自 SEC 公开文档 + Form 4 XML schema，**未实地验证**。 ║
║  主脑复核命令：                                                         ║
║    $env:PYTHONUTF8='1'; py market-analysis/scripts/fetch_insider.py    ║
║  看是否真能：① 拉到 daily-index ② 抓到 .xml ③ 解析出 P 买入行。         ║
╚══════════════════════════════════════════════════════════════════════╝
